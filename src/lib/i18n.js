...
const translations = {
  sv: {
    ...
    mpge_label: 'MPGe',
    kwh100mi_label: 'kWh per 100 miles',
    kml_label: 'Kilometer per liter',
    ...
    hint_kwh100mi: 'Vanlig i UK (t.ex. Autocar, What Car?)',
    hint_kml: 'Vanlig i Japan, Indien och Sydkorea',
    ...
    placeholder_kwh100mi: 't.ex. 27',
    placeholder_kml: 't.ex. 12',
  ...
  en: {
    ...
    mpge_label: 'MPGe',
    kwh100mi_label: 'kWh per 100 miles',
    kml_label: 'Kilometres per litre',
    hint_us_gal: '1 US gallon = 3.785 L',
    hint_uk_gal: '1 imp. gallon = 4.546 L',
    ...
    hint_mpge: 'Miles per gallon equivalent · 1 gal = 33.7 kWh (EPA)',
    hint_kwh100mi: 'Common in UK (e.g. Autocar, What Car?)',
    hint_kml: 'Common in Japan, India and South Korea',
    ...
    placeholder_kwh100mi: 'e.g. 27',
    placeholder_kml: 'e.g. 12',
    footer: '1 US gal = 3.785 L · 1 imp. gal = 4.546 L · 1 mile = 1.609 km · MPGe: 1 gal = 33.7 kWh (EPA)',
    lang_toggle: 'Svenska',
